<section class="bg-sipil-base text-light-base section-padding-x pt-28 pb-12">
  <div class="max-w-screen-xl mx-auto">
    <div class="max-w-3xl">
      <span class="gradient-to-r text-dark-base from-blue-quaternary to-light-base bg-gradient-to-br flex items-center gap-2 mb-4 w-fit py-1 px-3 rounded-md">
        <svg
          class="w-4"
          fill="currentColor"
        ...
        <p class="extra-small-font-size">Pusat Unduhan</p>
      </span>
      <h1 class="font-bold mb-6">Unduhan Dokumen Laboratorium Teknik Sipil</h1>
      <p class="mb-6">
