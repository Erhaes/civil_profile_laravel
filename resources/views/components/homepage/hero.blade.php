  ...
  <div class="max-w-screen-xl mx-auto flex gap-4 flex-col xl:flex-row justify-between relative">
    <div class="hero-animate-1">
      <div class="text-dark-base dark:text-light-base rounded-lg mb-4">
        ...
        <p class="mb-4 mr-5 md:mb-8 mr-0 text-justify">
        ...
        <div class="flex flex-wrap gap-2">
          <a
            ...
            class="rounded-md bg-blue-base text-light-base py-2 px-4 font-semibold hover:bg-blue-quaternary hover:text-blue-base transition duration-300 small-font-size"
          >
